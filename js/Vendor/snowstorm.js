...
function SnowStorm() {
  ...
  this.snowColor = '#E6E6F0';        // Don't eat (or use?) yellow snow.
  ...
  this.flakeWidth = 25;            // max pixel width for snow element
  this.flakeHeight = 25;           // max pixel height for snow element
  ...
  this.SnowFlake = function(parent,type,x,y) {
    ...
    this.twinkleFrame = 0;
    this.active = 1;
    this.fontSize = (10+(this.type/5)*10) * 4;   //CHANGE THE SIZE HERE - SINCE THEY ARE JUST BULLET POINTS
    this.o = document.createElement('div');
    this.o.innerHTML = storm.snowCharacter;
    this.o.style.color = storm.snowColor;
    this.o.style.position = (fixedForEverything?'fixed':'absolute');
    this.o.style.width = storm.flakeWidth+'px';  //CHECK HERE
